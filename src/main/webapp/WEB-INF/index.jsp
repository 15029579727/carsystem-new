        ...
        <div id="sidebar"  class="nav-collapse ">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a  href="#" onclick="userSearch()">ユーザー情報</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;" >
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a  href="#" onclick="getBrandInfo()">プランド情報</a></li>
                    </ul>
                    <ul class="sub">
                    ...
                    <div class="row mt">
                        ...
                        <div class="col-md-4 col-sm-4 mb">
                            <div class="white-panel pn">
                                ...
                                <div class="centered">
                                    <img src="/static/img/product.png" width="120">
                                </div>
                            </div>
                        </div><!-- /col-md-4 -->
                        <div class="col-md-4 mb">
                            ...
                            <div class="white-panel pn">
                                ...
                                <p><img src="/static/img/ui-zac.jpg" class="img-circle" width="80"></p>
                                <p><b>Zac Snider</b></p>
                                <div class="row">
                                    <div class="col-md-6">
...
<script type="application/javascript">
    ...
    function getBrandInfo() {
        window.self.location.href="/car/getBrandInfo";
    }
    ...
    function userSearch() {
        window.self.location.href="/user/getUserInfo";
    }
</script>
</body>
</html>